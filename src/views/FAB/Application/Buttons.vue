    ...
    <section class="form-section">
      ...
      <div class="button-container">
        ...
        <el-form-item v-else-if="props.applicationType==='load'">
          <el-button type="primary" class="action-button" @click="submitForm('update')">
            업데이트
          </el-button>
        </el-form-item>
        <el-form-item>
          <el-button type="warning" class="action-button" @click="resetForm" disabled>
            초기화
          </el-button>
        </el-form-item>
        <el-form-item>
          <el-button type="danger" class="action-button" @click="cancelForm" disabled>
            삭제
          </el-button>
        </el-form-item>
      </div>
