<template>
  <div class="container">
    ...
    >
      <el-row :gutter="50">
        <el-col :span="10">
          <el-form-item label="Wafer Type" prop="name">
            <el-radio-group class="mgb20" v-model="form.name">
              <el-radio-button label="NS" style="margin-right: 10px"
                >NS</el-radio-button
              >
              <el-radio-button label="TS" style="margin-right: 10px"
                >TS</el-radio-button
              >
              <el-radio-button label="HS">HS</el-radio-button>
            </el-radio-group>
          </el-form-item>
...
function syncProductNameFromInputValues() {
  form.productName = inputValues.value.join("").trim();
}
