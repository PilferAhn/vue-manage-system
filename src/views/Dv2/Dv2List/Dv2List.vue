<template>
  <div>
    <el-table :data="formattedData" :span-method="tableSpanMethod" class="custom-table">
      ...
      <!-- 프로젝트 관련 (rowSpan=2) -->
      <el-table-column label="Project" :align="'center'" fixed="left">
        ...
        <el-table-column label="顧客" prop="client" :align="'center'" width="100">
          <template #default="scope">
      ...
      <el-table-column label="区分" prop="category" :align="'center'" fixed="left">
        <template #default="scope">
          <el-input v-model="scope.row.category" class="table-input" />
        </template>
      </el-table-column>

      <el-table-column label="Band" prop="band" :align="'center'" width="150" fixed="left">
        <template #default="scope">
      ...
      <el-table-column label="GROUP" prop="group" :align="'center'" width="100">
        <template #default="scope">
          <el-input v-model="scope.row.group" class="table-input" />
        </template>
      </el-table-column>
      ...
      <el-table-column label="現段階 現 단계" :align="'center'">
        ...
        <el-table-column label="차수" prop="turn" :align="'center'" width="100">
          <template #default="scope">
        ...
        >
          <template #default="scope">
            <el-input v-model="scope.row.dateOfMdr" class="table-input" />
          </template>
        </el-table-column>
        ...
        >
          <template #default="scope">
            <el-input v-model="scope.row.dateOfFabIn" class="table-input" />
          </template>
        </el-table-column>
        ...
        >
          <template #default="scope">
            <el-input v-model="scope.row.dateOfFabOut" class="table-input" />
          </template>
        </el-table-column>
        ...
        >
          <template #default="scope">
            <el-input v-model="scope.row.dateOfHqOut" class="table-input" />
          </template>
        </el-table-column>
        ...
        >
          <template #default="scope">
            <el-input v-model="scope.row.dateOfWhcIn" class="table-input" />
          </template>
        </el-table-column>
        ...
        >
          <template #default="scope">
            <el-input v-model="scope.row.dateOfAssyIn" class="table-input" />
          </template>
        </el-table-column>
        ...
        >
          <template #default="scope">
            <el-input v-model="scope.row.dateOfDCOut" class="table-input" />
          </template>
        </el-table-column>
        ...
        >
          <template #default="scope">
            <el-input v-model="scope.row.dateOfMeasIn" class="table-input" />
          </template>
        </el-table-column>
        ...
        >
          <template #default="scope">
            <el-input v-model="scope.row.dateOfConfirm" class="table-input" />
          </template>
        </el-table-column>
      </el-table-column>
...
/**
 * 📌 데이터를 2줄씩 표시할 수 있도록 전처리
 */
const formattedData = computed(() => {
  return dv2Data.flatMap((row) => [
    {
      ...row,
