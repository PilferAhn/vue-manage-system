...
const routes: RouteRecordRaw[] = [
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        component: () =>
          import(
            /* webpackChunkName: "table" */ "../views/ProductPage/ApplicationPage/PDTRequestForm.vue"
          ),
      },
      {
        ...
        component: () =>
          import(
            /* webpackChunkName: "table" */ "../views/ProductPage/MeasurementPage/MeasurementInfo.vue"
          ),
      },
      {
      ...
      },
      {
        ...
        component: () =>
          import(
            /* webpackChunkName: "table" */ "../views/AdminPage/ApplicationList.vue"
          ),
      },
      {
        ...
        component: () =>
          import(
            /* webpackChunkName: "table" */ "../views/AdminPage/Machine/MachineList.vue"
          ),
      },
      {
        ...
        component: () =>
          import(
            /* webpackChunkName: "table" */ "../views/AdminPage/Machine/MachineComponent.vue"
          ),
      },
      {
        ...
        component: () =>
          import(
            /* webpackChunkName: "table" */ "../views/AdminPage/ViewApplication.vue"
          ),
      },
      {
      ...
      },
      {
        ...
        component: () =>
          import(
            /* webpackChunkName: "table" */ "../views/ProductPage/MeasurementPage/ReservedMeasurement.vue"
          ),
      },
      {
        ...
        component: () =>
          import(
            /* webpackChunkName: "table" */ "../views/ProductPage/MeasurementPage/CompletedMeasurementList.vue"
          ),
      },
      {
        ...
        component: () =>
          import(
            /* webpackChunkName: "table" */ "../views/ProductPage/MeasurementPage/MeasurementDetail.vue"
          ),
      },
      {
      ...
      },
      {
        ...
        component: () =>
          import(
            /* webpackChunkName: "table" */ "../views/ProductPage/ApplicationPage/MyProductApplicationDetail.vue"
          ),
      },

      {
        ...
        component: () =>
          import(
            /* webpackChunkName: "table" */ "../views/TegPage/MeasurementQueue/TegMeasurementQue.vue"
          ),
      },
      {
        ...
        component: () =>
          import(
            /* webpackChunkName: "table" */ "../views/TegPage/MeasurementQueue/TegMeasurementFinishedQue.vue"
          ),
      },
      {
        ...
        component: () =>
          import(
            /* webpackChunkName: "table" */ "../views/ProductPage/LoadProductApp.vue"
          ),
      },
      {
        path: "/admin/pdt/application",
        ...
        component: () =>
          import(
            /* webpackChunkName: "table" */ "../views/ProductPage/PDTApplication.vue"
          ),
      },
      {
        ...
        component: () =>
          import(
            /* webpackChunkName: "table" */ "../views/AdminPage/PDT/Statistic/PdtStatistic.vue"
          ),
      },
      {
        ...
        component: () =>
          import(
            /* webpackChunkName: "table" */ "../views/TegPage/Application/TegApplication.vue"
          ),
      },

      {
        path: "/teg/create-teg-application2",
        ...
        component: () =>
          import(
            /* webpackChunkName: "table" */ "../views/TegPage/Application/CreateApplication.vue"
          ),
      },
      {
      ...
      },
      {
        ...
        component: () =>
          import(
            /* webpackChunkName: "table" */ "../views/AdminPage/TEG/TegApplicationListPage.vue"
          ),
      },
      {
        ...
        component: () =>
          import(
            /* webpackChunkName: "table" */ "../views/AdminPage/TEG/TegWaitingList.vue"
          ),
      },
      {
        path: "/teg/teg-queue",
      ...
      },
      {
        ...
        component: () =>
          import(
            /* webpackChunkName: "table" */ "../views/Calculator/SParameter/SParameter.vue"
          ),
      },
      {
        ...
        component: () =>
          import(
            /* webpackChunkName: "table" */ "../views/Calculator/SParameter/TcfCal.vue"
          ),
      },
      {
        ...
        component: () =>
          import(
            /* webpackChunkName: "table" */ "../views/Calculator/RfLimit/test.vue"
          ),
      },
      {
        ...
        component: () =>
          import(
            /* webpackChunkName: "table" */ "../views/Calculator/RfLimit/TestRfLimit.vue"
          ),
      },
      {
        path: "/cer/cer0",
        ...
        component: () =>
          import(/* webpackChunkName: "table" */ "../views/CER/CER.vue"),
      },
      {
        path: "/cer/cer0-list",
        name: "CER0-list",
        ...
        component: () =>
          import(
            /* webpackChunkName: "table" */ "../views/CER/Cer0/cer0List.vue"
          ),
      },
      {
        path: "/cer/cer0-list1",
        ...
        component: () =>
          import(
            /* webpackChunkName: "table" */ "../views/CER/Cer0/cer0List1.vue"
          ),
      },
      {
        path: "/cer/cer0-list2",
        ...
        component: () =>
          import(
            /* webpackChunkName: "table" */ "../views/CER/Cer0/cer0List2.vue"
          ),
      },
      {
        ...
        component: () =>
          import(
            /* webpackChunkName: "table" */ "../views/CER/Cer0/loadCer0.vue"
          ),
      },
      {
        ...
        component: () =>
          import(
            /* webpackChunkName: "table" */ "../views/SparameterPage/SParameterList.vue"
          ),
      },
      {
        path: "/rules/pdt",
        ...
        component: () =>
          import(/* webpackChunkName: "table" */ "../views/Rules/PdtRules.vue"),
      },
      {
        path: "/rules/pdt2",
        name: "Rules2",
      ...
      },
      {
        ...
        component: () =>
          import(
            /* webpackChunkName: "charts" */ "../views/AdminPage/Statistic/charts.vue"
          ),
      },
      {
        path: "/form",
      ...
      },
      {
        ...
        component: () =>
          import(
            /* webpackChunkName: "table" */ "../views/Solder/ApplicationList/SolderApplicationList.vue"
          ),
      },
      {
      ...
      },
      {
        ...
        component: () =>
          import(
            /* webpackChunkName: "table" */ "../views/Solder/Application/NetworkAnalyzer.vue"
          ),
      },
      {
        ...
        component: () =>
          import(
            /* webpackChunkName: "table" */ "../views/Mdr/General/Application/CreateApplication.vue"
          ),
      },
      {
  ...
  },
  {
    ...
    component: () =>
      import(
        /* webpackChunkName: "login" */ "../views/RegisterPage/Register.vue"
      ),
  },
  {
    path: "/403",
